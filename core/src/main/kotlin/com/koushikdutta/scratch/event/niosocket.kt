...
class AsyncNetworkServerSocket internal constructor(val server: AsyncEventLoop, private val channel: ServerSocketChannel) : AsyncServerSocket<AsyncNetworkSocket>, AsyncAffinity by server {
...
class AsyncDatagramSocket internal constructor(val server: AsyncEventLoop, private val channel: DatagramChannel, private val key: SelectionKey) : AsyncSocket, NIOChannel, AsyncAffinity by server {
    val localPort = channel.socket().localPort
...
class AsyncNetworkSocket internal constructor(val loop: AsyncEventLoop, private val channel: SocketChannel, private val key: SelectionKey) : AsyncRead, AsyncWrite, AsyncSocket, NIOChannel, AsyncAffinity by loop {
