...
typealias Inet4Address = java.net.Inet4Address
typealias Inet6Address = java.net.Inet6Address
typealias InetSocketAddress = java.net.InetSocketAddress

fun getLoopbackAddress(): InetAddress {
    return InetAddress.getLoopbackAddress()
}


fun milliTime(): Long = TimeUnit.NANOSECONDS.toMillis(System.nanoTime())
fun nanoTime(): Long = System.nanoTime()

open class AsyncEventLoop: AsyncScheduler<AsyncEventLoop>() {
