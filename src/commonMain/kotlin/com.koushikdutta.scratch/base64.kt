...
fun String.encodeBase64ToString(): String = this.encodeToByteArray().encodeBase64().decodeToString()
fun String.encodeBase64ToByteArray(): ByteArray = this.encodeToByteArray().encodeBase64()
